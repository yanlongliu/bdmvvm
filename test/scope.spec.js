...
//             scope.aFunction = _.constant(42); expect(scope.$apply('aFunction()')).toBe(42);
//         });
...
//         var fn = parse('42'); expect(fn.literal).toBe(true);
//     });
//     it('marks strings literal', function () {
//         var fn = parse('"abc"'); expect(fn.literal).toBe(true);
//     });
//     it('marks booleans literal', function () {
//         var fn = parse('true'); expect(fn.literal).toBe(true);
//     });
//     it('marks arrays literal', function () {
//         var fn = parse('[1, 2, aVariable]'); expect(fn.literal).toBe(true);
//     });
//     it('marks objects literal', function () {
//         var fn = parse('{a: 1, b: aVariable}'); expect(fn.literal).toBe(true);
//     });
//     it('marks integers constant', function () {
//         var fn = parse('42'); expect(fn.constant).toBe(true);
//     });
//     it('marks strings constant', function () {
//         var fn = parse('"abc"'); expect(fn.constant).toBe(true);
//     });
//     it('marks booleans constant', function () {
//         var fn = parse('true'); expect(fn.constant).toBe(true);
//     });
//     it('marks identifiers non-constant', function () {
//         var fn = parse('a'); expect(fn.constant).toBe(false);
//     });
