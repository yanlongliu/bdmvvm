...
//         setupModuleLoader(window); expect(window.angular).toBeDefined();
//     });
//     it('exposes the angular module function', function () {
//         setupModuleLoader(window); expect(window.angular.module).toBeDefined();
//     });
//     it('exposes the angular module function just once', function () {
//         setupModuleLoader(window);
//         var module = window.angular.module;
//         setupModuleLoader(window); expect(window.angular.module).toBe(module);
//     });
...
//             var myModule = window.angular.module('myModule', ['myOtherModule']); expect(myModule.requires).toEqual(['myOtherModule']);
//         });
